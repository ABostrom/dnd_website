...
import enum
class SpellComponent(str, enum.Enum):
    V = "V"
    S = "S"
    M = "M"

class SpellSchools(str, enum.Enum):
...
class SpellDataBase:
    ...
    def __init__(self):
        ...
        self.spells = {
            ...
            2 :  Spell(1, "Mending", SpellSchools.Transmutation, SpellLevels.Cantrip, "1 action", 0, "Instantaneous", [SpellComponent.V, SpellComponent.S, SpellComponent.M], 
