...
@app.route('/api/spellcasting/spells_by_name/', methods=['GET'], defaults={'spell_level': None, 'spell_name': None})
@app.route('/api/spellcasting/spells_by_name/<int:spell_level>/', methods=['GET'], defaults={'spell_name': None})
